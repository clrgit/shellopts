module ShellOpts
  module Grammar
    ...
    # An GrammarNode models the program specification
...
#     def value?(value) ... end
    ...
    class OptionGroup < Node
      ...
      # Duck typing for compatibility with GrammarNode (TODO: maybe just make
      # OptionGroup an GrammarNode and be over with it)
